...
const SignUp = () => {
  ...
  const signUp = async (_body) => {
    ...
    try {
      ...
      if (err.response.data.code == 11000) setError(err.response.data.err_msg);
    }
        ...
        <form onSubmit={handleSubmit(onSub)} className="mt-8 space-y-6" >
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div >
              ...
              <input
                {...register('fullName', { required: {value:true,message:'name required'}, minLength: {value:2, message:'name too short'}, maxLength: {value:20, message:'too long'} })}
                type="text"
            ...
            <div >
              ...
              <input
                {...register('email', { required: {value:true, message:'email required'}, pattern:{value:emailReg })}
                type="email"
          ...
          {error && <p className='text-red-600'>password is not match </p>}
